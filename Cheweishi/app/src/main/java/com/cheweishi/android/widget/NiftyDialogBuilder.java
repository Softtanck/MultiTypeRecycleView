...
import com.cheweishi.android.animation.BaseEffects;
import com.cheweishi.android.animation.Effectstype;
...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
	 ...
	 * @return
	 */
	public NiftyDialogBuilder withButtonDrawable(int resid1,int resid2) {
		mButton1.setBackgroundResource(resid1);
		mButton2.setBackgroundResource(resid2);
		return this;
	}
