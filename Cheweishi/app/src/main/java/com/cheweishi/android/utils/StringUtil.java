 ...
 * 
 * @author zhangq<br>
 *         这个类里面原本string转基本类型都是封装型，现在改为基本类型
 */
public class StringUtil {
	 ...
	 * @return
	 */
	public static Double[] getDoubleArray(String str, String spliter) {
		if (isNull(str)) {
			return new Double[0];
		}
		String[] strs = str.split(spliter);
	 ...
	 * @return
	 */
	public static String getDateForFormat2(String strDate, String format) {
		try {
	...
	public static boolean isEmpty(String str) {
		...
		return null == str || str.equals("null") || "".equals(str) || str.length() == 0 ? true
				: false;
	}
