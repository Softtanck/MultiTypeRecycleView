...
public class PayUtils {
     ...
     */
    public void pay(final BaseActivity context, String name, String desc,
                    double money) {
        this.context = context;
        mHandler = new MyHandler(context, listener);
        // 订单
        String orderInfo = getOrderInfo(name, desc, ((float) money) + "");
    ...
    static class MyHandler extends Handler {
        ...
        MyHandler(Activity activity, OnPayListener listener) {
...
//		orderInfo += "&it_b_pay=\"30m\"";
    ...
    public void setOutTradeNo(String no) {
        this.no = no;
    }
