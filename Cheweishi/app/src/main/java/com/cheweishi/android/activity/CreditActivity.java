...
public class CreditActivity extends Activity {
  ...
  //自定义导航栏，包含 后退按钮，页面标题，分享按钮（默认隐藏）
    protected void initNavigationBar(){
        ...
        mBackView.setBackgroundResource(R.drawable.left);
        RelativeLayout.LayoutParams mBackLayout=new RelativeLayout.LayoutParams(dp10, dp20);
        ...
        mBackLayout.setMargins(dp10, dp10, dp10, dp10);
