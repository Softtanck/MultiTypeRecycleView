...
//import com.cheweishi.android.entity.ReturnResponse;
...
// */
//public class ShopOrderReturnListAdapter extends BaseAdapter {
//
//    private Context context;
//
//    private List<ReturnResponse.MsgBean> list;
//
...
//
//
//    public ShopOrderReturnListAdapter(Context context, List<ReturnResponse.MsgBean> list) {
//        this.context = context;
//        this.list = list;
//    }
//
//    public void setData(List<ReturnResponse.MsgBean> list) {
//        this.list = list;
...
//                String iconString = list.get(position).getReturnsItem().get(tempP).getThumbnail();
...
//                holder.orderName.setText(list.get(position).getReturnsItem().get(tempP).getName());
//                holder.number.setText("x" + list.get(position).getReturnsItem().get(tempP).getQuantity());
//                holder.orderMoney.setText("￥" + list.get(position).getReturnsItem().get(tempP).getPrice());
...
////                    detail.putExtra("productId", list.get(position).getReturnsItem().get(list.get(position).getOrderPosition()).getProduct().getId());
////                    context.startActivity(detail);
////                    break;
//            }
//        }
...
//        int number = list.get(position).getReturnsItem().size();
//        StringBuffer orderIds = new StringBuffer();
//        for (int i = 0; i < number; i++) {
//            if (0 == i)
//                orderIds.append(String.valueOf(list.get(position).getReturnsItem().get(i).getId()));
//            else
//                orderIds.append("," + list.get(position).getReturnsItem().get(i).getId());
//        }
