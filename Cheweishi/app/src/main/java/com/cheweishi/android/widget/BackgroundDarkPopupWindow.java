...
public class BackgroundDarkPopupWindow extends PopupWindow {
    ...
    public BackgroundDarkPopupWindow(View contentView, int width, int height, int bottomHeight) {
        ...
        if (contentView != null) {
            ...
            mScreenHeight = dm.heightPixels - bottomHeight;
        }
    }
