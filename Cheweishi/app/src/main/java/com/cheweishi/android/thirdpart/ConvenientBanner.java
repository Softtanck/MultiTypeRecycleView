package com.cheweishi.android.thirdpart;
...
import com.cheweishi.android.thirdpart.listener.CBPageChangeListener;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner(Context context, AttributeSet attrs) {
        ...
        newView = a.getBoolean(R.styleable.ConvenientBanner_new_layout, false);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        if (!newView) {
            View hView = LayoutInflater.from(context).inflate(R.layout.adv_include_viewpager, this, true);
    ...
    public void setView(Context context, int id) {
        View hView = LayoutInflater.from(context).inflate(id, this, true);
        viewPager = (CBLoopViewPager) hView.findViewById(R.id.cbLoopViewPager);
        loPageTurningPoint = (ViewGroup) hView.findViewById(R.id.loPageTurningPoint);
        initViewPagerScroll();
    }
    ...
    public ConvenientBanner setPages(CBViewHolderCreator holderCreator, List<T> datas, Activity activity) {
        this.mDatas = datas;
        pageAdapter = new CBPageAdapter(holderCreator, mDatas, activity);
