...
import com.cheweishi.android.utils.MD5Tool;
...
public class HttpUtils {
    ...
    public HttpUtils(int connTimeout, String userAgent) {
        ...
        this.httpClient.addRequestInterceptor(new HttpRequestInterceptor() {
            public void process(HttpRequest httpRequest, HttpContext httpContext)
                ...
                httpRequest.setHeader("Authorization", MD5Tool.md5(str + ":"
                        + "jfinal.chcws.com").toUpperCase());
            }
        });
    ...
    public <T> HttpHandler<T> send(HttpMethod method, String url,
        ...
        if (url == null) {
            ...
            com.lidroid.xutils.http.client.HttpRequest request = new com.lidroid.xutils.http.client.HttpRequest(
                    method, url);
    ...
    public HttpHandler<File> download(String url, String target,
        ...
        return this.download(HttpMethod.GET, url, target, params, false, false,
                callback);
    }
    ...
    public HttpHandler<File> download(String url, String target,
                                      ...
                                      RequestCallBack<File> callback) {
        return this.download(HttpMethod.GET, url, target, params, autoResume,
                false, callback);
    }
    ...
    public HttpHandler<File> download(HttpMethod method, String url,
                                      String target, RequestParams params, RequestCallBack<File> callback) {
        return this.download(method, url, target, params, false, false,
                callback);
    }
    ...
    public HttpHandler<File> download(HttpMethod method, String url,
                                      ...
                                      RequestCallBack<File> callback) {
        return this.download(method, url, target, params, autoResume, false,
                callback);
    }
    ...
    public HttpHandler<File> download(HttpMethod method, String url,
        ...
        if (url == null) {
            ...
            com.lidroid.xutils.http.client.HttpRequest request = new com.lidroid.xutils.http.client.HttpRequest(
                    method, url);
            HttpHandler handler = new HttpHandler(this.httpClient,
                    this.httpContext, this.responseTextCharset, callback);
    ...
    private <T> HttpHandler<T> sendRequest(
            com.lidroid.xutils.http.client.HttpRequest request,
            RequestParams params, RequestCallBack<T> callBack) {
        HttpHandler handler = new HttpHandler(this.httpClient,
                this.httpContext, this.responseTextCharset, callBack);
        handler.setExpiry(this.currentRequestExpiry);
    ...
    private ResponseStream sendSyncRequest(
            ...
            RequestParams params)
            throws com.lidroid.xutils.exception.HttpException {
        SyncHttpHandler handler = new SyncHttpHandler(this.httpClient,
                this.httpContext, this.responseTextCharset);
        handler.setExpiry(this.currentRequestExpiry);
        handler.setHttpRedirectHandler(this.httpRedirectHandler);
